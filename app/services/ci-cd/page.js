import CICDClient from "./CICDClient";

export const metadata = {
  title: "CI/CD Pipeline Automation for Startups | Zenteq",
  description:
    "Zenteq builds reliable CI/CD pipelines using GitHub Actions and AWS CodePipeline for fast and safe deployments.",
};
