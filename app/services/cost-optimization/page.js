import CostOptimizationClient from "./CostOptimizationClient";

export const metadata = {
  title: "AWS Cost Optimization for Startups | Zenteq",
  description:
    "Zenteq helps startups reduce AWS costs through architecture reviews, right-sizing, and cost-aware DevOps practices.",
};
